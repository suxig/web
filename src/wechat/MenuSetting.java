...
public class MenuSetting {
	...
	public static String appId = "wx13af3458dc23a31d";
    public static String appSecret= "e607814f356091ace53da462f770c2a7"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://te68c5.natappfree.cc/test1/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
